...
/**
 * GetCallHistoryAPIResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Voximplant
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCallHistoryAPIResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'GetCallHistory API Response';
    ...
    /**
     * Sets total_count
     * @param int $total_count The total found call session count (sync mode).
     * @return $this
     */
    ...
    /**
     * Sets count
     * @param int $count The returned call session count (sync mode).
     * @return $this
     */
