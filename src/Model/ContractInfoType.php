...
/**
 * ContractInfoType Class Doc Comment
 *
 * @category    Class */
 // @description The contract info (the ContractorInfoType field).
/** 
 * @package     Voximplant
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContractInfoType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ContractInfoType';
     ...
     * @param string $agreement_number The agreement number.
     * @return $this
     */
    ...
    /**
     * Sets agreement_date
     * @param string $agreement_date The agreement date in format: YYYY-MM-DD
     * @return $this
     */
