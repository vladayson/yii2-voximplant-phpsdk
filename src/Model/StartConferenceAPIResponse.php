...
/**
 * StartConferenceAPIResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Voximplant
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StartConferenceAPIResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'StartConference API Response';
