...
/**
 * AddRuleAPIResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Voximplant
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AddRuleAPIResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AddRule API Response';
    ...
    /**
     * Sets rule_id
     * @param int $rule_id The new rule ID.
     * @return $this
     */
