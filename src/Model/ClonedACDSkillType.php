...
/**
 * ClonedACDSkillType Class Doc Comment
 *
 * @category    Class */
 // @description The cloned ACD skill info.
/** 
 * @package     Voximplant
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ClonedACDSkillType implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ClonedACDSkillType';
    ...
    /**
     * Sets skill_id
     * @param int $skill_id The ACD skill ID.
     * @return $this
     */
    ...
    /**
     * Sets skill_name
     * @param string $skill_name The ACD skill name.
     * @return $this
     */
