<?php
/**
 * CheckAuthorizedAccountIPAPIResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CheckAuthorizedAccountIPAPIResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Voximplant
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CheckAuthorizedAccountIPAPIResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CheckAuthorizedAccountIP API Response';
    ...
    /**
     * Sets result
     * @param bool $result True if IP is allowed.
     * @return $this
     */
    ...
    /**
     * Sets authorized_ip
     * @param string $authorized_ip The matched authorized IP or network (if found).
     * @return $this
     */
